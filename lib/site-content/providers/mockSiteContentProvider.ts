...
const metadata: ProviderMetadata = {
  ...
  disclosure: 'Storm King place and values language is grounded in official school sources. Carbon goals, progress, offsets, and project results remain placeholders until approved.',
  availability: 'partial',
  publicationStatus: 'prototype',
  freshness: { state: 'not-applicable', observedAt: '2026-08-27', staleAfterMinutes: null },
  coverage: {
    kind: 'public-subset',
    label: 'Three-section public content prototype',
...
const start: StartContent = {
  introduction: 'START—the Sustainability Tracking, Analytics & Roadmap Tool—is a sustainability framework created by the Green Schools Alliance for benchmarking, planning, and tracking progress.',
