...
const metadata: ProviderMetadata = {
  ...
  freshness: { state: 'not-applicable', observedAt: '2026-08-22T13:40:00-04:00', staleAfterMinutes: null },
  coverage: {
    kind: 'selected-devices',
    label: 'Illustrative selected-device coverage',
    note: 'These simulated smart-plug readings represent a selected-device example, not total campus electricity demand.',
    monitoredDeviceCount: null,
  },
  reportingPeriod: null,
  sourceType: 'synthetic',
  verification: { state: 'not-applicable', reference: null, note: 'Simulated readings are not eligible for verification.' },
  methodologyNote: 'Deterministic selected-device simulation; not a campus energy method.',
};
...
const snapshot: EnergySnapshot = {
  ...
  quality: 'prototype',
  coverage: structuredClone(metadata.coverage) as EnergySnapshot['coverage'],
};
