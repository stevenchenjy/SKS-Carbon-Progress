...
const qualityLegend = [
  { quality: 'measured' as const, text: 'Captured directly from a meter, bill, count, or other primary record.' },
  { quality: 'estimated' as const, text: 'Calculated from a documented assumption when direct activity data is unavailable.' },
  { quality: 'verified' as const, text: 'Reviewed against an identified external standard or assurance process.' },
  { quality: 'prototype' as const, text: 'Synthetic content used only to design and test this platform.' },
];
